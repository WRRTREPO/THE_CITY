...
The latest sealed proof is [Crew Arrival Into Live Commitment Proof — v0.1.0](Crew%20Arrival%20Into%20Live%20Commitment%20Proof%20-%20Draft.md), with its [evidence record](Crew%20Arrival%20Into%20Live%20Commitment%20Proof%20Evidence%20-%20v0.1.0.md). It is sealed at Git commit `7c076ff` and records 57 passing Python checks, a UE 5.8 build, captured early/late physical proposals, and independently fresh materialization of control, early, and late terminal records.
