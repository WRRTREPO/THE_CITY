...
**Supersedes:** [v0.1.1](THE_CITY%20Development%20Capacity%20and%20Progress%20Note%20-%20v0.1.1.md)
...
The latest sealed proof is [Bounded Agent Commitment Selection Proof — v0.1.0](Bounded%20Agent%20Commitment%20Selection%20Proof%20-%20Draft.md), with its [evidence record](Bounded%20Agent%20Commitment%20Selection%20Proof%20Evidence%20-%20v0.1.0.md). It records 79 passing Python checks, frozen action-definition hashes, route-feasibility, hidden-fact exclusion, deterministic-tie witnesses, canonical proposal revalidation, and a 32-member self-excluding release manifest.
