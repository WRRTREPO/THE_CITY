...
The governing continuation is [v0.7.0-draft.70](Co-op%20Open-City%20FPS%20Simulation%20-%20v0.7%20Working%20Continuation.md).
[Simultaneous Physical Domains Proof v0.1.0-draft.2](Simultaneous%20Physical%20Domains%20Proof%20-%20Draft.md)
...
head-unconfirmed/synchronized/stale/invalid physical-head law. The physical
guard cannot gate canonical execution. Refresh rebuilds canonical-derived
...
The exact process-liveness, visible-input, release-DAG, member-set, and manifest
contracts are fixed for final review. The proof is not frozen. No implementation
