...
**Supersedes:** [v0.1.3](THE_CITY%20Development%20Capacity%20and%20Progress%20Note%20-%20v0.1.3.md)
...
fixture, different non-authoritative execution granularities converge on the
same authoritative causal history.
...
The latest sealed proof is [Causal-LOD Equivalence Proof — v0.1.0](Causal-LOD%20Equivalence%20Proof%20Evidence%20-%20v0.1.0.md). It records 104 passing Python checks, four policy witnesses, R0-as-sole-transaction-pre-state provenance, runtime fail-closed checks, an equivalence oracle, source audit, replay, and a 19-member self-excluding release manifest.
...
- Causal-LOD equivalence beyond the one neutral fixture: external inputs during skipped intervals, multiple active commitments, stochastic draws, actual FPS/materialization fidelity changes, and repeated city-scale promotion/demotion;
...
skipped interval or a second independently scheduled commitment—then freeze its
own authority, equivalence, and failure boundaries before implementation.
